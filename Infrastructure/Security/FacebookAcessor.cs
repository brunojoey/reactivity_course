...
{
  public class FacebookAcessor : IFacebookAccessor
  {
    private readonly HttpClient _httpClient;
    private readonly IOptions<FacebookAppSettings> _config;
    public FacebookAcessor(IOptions<FacebookAppSettings> config)
    {
      _config = config;
    ...
    private async Task<T> GetAsync<T>(string accessToken, string endpoint, string args)
    {
        ...
        // will take our string and convert it into the type that we are passing into the GetAsync 
    }
  }
}